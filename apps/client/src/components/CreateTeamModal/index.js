...
export default function CreateUser() {
  ...
  async function createTeam() {
    try {
      // Replaced Next.js API route with a full URL
      const response = await fetch("https://your-api-domain.com/api/v1/admin/team/create", {
        method: "POST",
        headers: {
      ...
      if (result.success) {
        ...
        // Optionally trigger a refresh of team data here
        // For example: onTeamCreated(); (if passed as a prop)
      } else {
