  ...
  return React.createElement("div", null,
    React.createElement("main", { className: "relative" },
      React.createElement("div", { className: "mt-4" },
        React.createElement("div", { className: "m-2 space-y-4 p-4" },
          React.createElement("div", { className: "py-6 px-4 sm:p-6 lg:pb-8" },
            React.createElement("div", { className: "space-y-4" },
              React.createElement(Switch.Group, {
                as: "div",
                className: "flex items-center justify-between"
              },
                React.createElement("span", { className: "flex-grow flex flex-col" },
                  React.createElement(Switch.Label, {
                    as: "span",
                    className: "text-sm font-medium text-foreground",
                    passive: true
                  }, "Ticket Creation"),
                  React.createElement(Switch.Description, {
                    as: "span",
              ...
              React.createElement(Switch.Group, {
                ...
                React.createElement("span", { className: "flex-grow flex flex-col" },
                  ...
                  React.createElement(Switch.Description, {
                    as: "span",
                    className: "text-sm text-foreground-muted"
                  }, "Get emailed when a ticket you're assigned to has it's status changed")
                ),
                React.createElement(Switch, {
            ...
            React.createElement("div", { className: "my-4 float-right" },
